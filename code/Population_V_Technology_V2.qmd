...
write.csv(SARD_Oak_trimmed, paste0(dir,"/data/SARD_Oak_Trimmed.csv"))
...
write.csv(SARD_Wil_trimmed, paste0(dir,"/data/SARD_Wil_Trimmed.csv"))
...
write.csv(SARD_All_Oak, paste0(dir,"SARD_All_Oak_Trimmed.csv"))

SARD_All |>
  filter(c14age < max(SARD_Wil_trimmed$c14age) &
                 c14age > min(SARD_Wil_trimmed$c14age)) -> SARD_All_Wil
write.csv(SARD_All_Wil, paste0(dir,"SARD_All_Wil_Trimmed.csv"))
